...
export const notificationsReducer = (state = { notifications: [] }, action) => {
    switch (action.type) {
        ...
        case NOTIFICATIONS_FAIL:
            return { loading: false, notifications: [], error: action.payload }
...
//mark as read
export const markAsReadReducer = (state = { notifications: [] }, action) => {
    switch (action.type) {
